...
exports.createMainWindow = function (serve) {
    ...
    var win = new electron_1.BrowserWindow(__assign(__assign({ maxWidth: 800, maxHeight: 600, minHeight: 400, minWidth: 300 }, electron_overlay_window_1.overlayWindow.WINDOW_OPTS), { webPreferences: {
